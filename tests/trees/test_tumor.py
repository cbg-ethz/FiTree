...
def test_tumor_1():
	...
	v2 = Subclone(node_id=2, mutation_ids=[3], seq_cell_number=50, parent=v1)

	tree = TumorTree(patient_id=0, tree_id=0, root=root, tumor_size=200)
...
def test_tumor_2():
	...
	tree = TumorTree(patient_id=0, tree_id=0, root=root, weight=0.5, sampling_time=0.5, tumor_size=200)
...
def test_tumor_3():
	...
	with pytest.raises(ValueError):
		tree = TumorTree(patient_id=0, tree_id=0, root=v1, tumor_size=200)
		tree = TumorTree(patient_id=0, tree_id=0, root=v2, tumor_size=200)
